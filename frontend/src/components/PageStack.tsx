import { PAGE_STACK_GAP_PX, PAPER_COLORS } from "@/lib/constants";
...
export default function PageStack({
  ...
  const naturalHeight = count * height + Math.max(0, count - 1) * PAGE_STACK_GAP_PX;

  return (
    <div
      className="pagestack-scaler"
      style={{
        width: width * scale,
